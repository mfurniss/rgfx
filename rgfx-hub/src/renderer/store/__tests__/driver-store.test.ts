...
describe('driver-store', () => {
  ...
  describe('onSystemStatusUpdate', () => {
    ...
    it('should notify when new system error is detected', () => {
      ...
      useDriverStore.getState().onSystemStatusUpdate(statusWithError);
    ...
    it('should not notify when system errors count stays the same', () => {
      ...
      useDriverStore.setState({
        ...
        systemStatus: {
          ...useDriverStore.getState().systemStatus,
          hubIp: '192.168.1.100',
          systemErrors: [error],
        },
      });
      ...
      useDriverStore.getState().onSystemStatusUpdate(statusWithSameError);
    ...
    it('should not notify when system errors count decreases', () => {
      ...
      useDriverStore.getState().onSystemStatusUpdate(statusWithNoErrors);
    ...
    it('should notify on IP change when hub IP was previously known', () => {
      ...
      useDriverStore.getState().onSystemStatusUpdate(statusWithNewIp);
    ...
    it('should not notify on initial IP discovery', () => {
      ...
      useDriverStore.getState().onSystemStatusUpdate(statusWithIp);
