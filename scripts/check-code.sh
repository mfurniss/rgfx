...
if [ "$HUB_CHANGES" = true ]; then
    ...
    npx depcheck --ignores="@types/*,electron,@electron-forge/*,@electron/windows-sign,@testing-library/*,@vitest/*,depcheck,license-checker,sharp,png2icons,colord,d3-scale,@eslint/*,cross-env"
